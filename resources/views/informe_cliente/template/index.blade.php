                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li class="nav-item">
                                    <a class="nav-link" href="index.html">Plantilla</a>
                                </li>
                                @can('consultorias.index')
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('consultorias.index') }}">Consultorias</a>
                                </li>
                                @endcan
                                <li class="nav-item">
                                    <a class="nav-link" href="index3.html">Articulos</a>
                                    <p> {{ asset('/uploads/Plantilla analisis ultima version.xlsxphp') }}</p>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="{{route('roles.index')}}">
                                <i class="fas fa-map-marker-alt"></i>Roles</a>
                        </li>
                        @endcan
                        <!-- <li class="has-sub">
                            <a class="js-arrow" href="#">
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                @can('plantilla.index')
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('plantilla.index') }}">Plantilla</a>
                                </li>
                                @endcan
                                @can('consultorias.index')
                                <li class="nav-item">
                                ...
                                @endcan
                                @can('consultorias.index')
                                <li class="nav-item"> <!--onsultorias ndices -->
                                    <a class="nav-link" href="{{ route('consultoriasplantilla.index') }}">C&I</a>
                                </li>
                                @endcan
                                @can('articulos.index')
                               <li class="nav-item">
                        ...
                        <li class="active has-sub">
                        <a class="js-arrow" href="#">
                                <i class="fas fa-users"></i>Cuentas</a>
                                ...
                                <li >
                        <a class="js-arrow" href="#">
                                <i class="fas fa-chart-line"></i><b>Analisis</b></a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('balance.index') }}">Amortizaciónn</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="active has-sub">
                        <a class="js-arrow" href="#">
                                <i class="fas fa-users"></i>Bandeja</a>

                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('bandeja.index') }}">Mis Consultorias</a>
                                </li>
