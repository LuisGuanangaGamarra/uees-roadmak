...
<div class="row">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">{{$Informe->titulo3}}</li>
  </ol>
</nav>
        ...
        <div class="col-md-10 border  rounded my-3">
            ...
            <div class="col-12 mb-3">
                ...
                @else
                    ...
                    <a class=" col-3 btn btn-dark" style="width:50%; font-size:10px" href="{{ route('informe.informacion_dos_edit',$consultoria) }}" target="_blank" onclick="window.open(this.href, this.target, 'top=70,left=350,width=777,height=907'); return false;">Editar</a> 
                @endif
                </center>
            </div>
        </div>       
