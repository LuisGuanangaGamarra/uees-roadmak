...
<div class="row">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">{{$Informe->titulo16}}</li>
  </ol>
</nav>
    </div>
</div>
...
@else
    ...
    <a class=" col-3 btn btn-dark" style="width:50%; font-size:10px" href="{{ route('informe.proyeccion_financiera_edit',$consultoria) }}" target="_blank" onclick="window.open(this.href, this.target, 'top=70,left=350,width=777,height=907'); return false;">Editar</a> 
@endif
 </center> 
 </div>
 </div>
